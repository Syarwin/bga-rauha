 ...
 */
class Scores extends \ARK\Helpers\DB_Manager
{
  ...
  public function compute()
  {
    ...
    foreach (Players::getAll() as $pId => $player) {
      ...
      self::computeD100($player, self::$scores);
    }
  ...
  protected function computeEmptyCells($player)
  {
    ...
    if ($player->hasPlayedCard('D132_HideFarmer')) {
      $card = ZooCards::get('D132_HideFarmer');
  ...
  protected function computeC135($player, $score)
  {
    if ($player->hasPlayedCard('C135_Constable')) {
      ZooCards::get('C135_Constable')->computeSpecialScore($score);
    }
  }

  protected function computeD100($player, $score)
  {
    if ($player->hasPlayedCard('D100_LordoftheManor')) {
      ZooCards::get('D100_LordoftheManor')->computeSpecialScore($score);
    }
  }
