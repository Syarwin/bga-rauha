...
class Stats extends \RAUHA\Helpers\DB_Manager
{
  ...
  public static function getStatName($multiplier)
  {
    switch ($multiplier) {
      case ANIMALS:
      case FLYING:
      case MARINE:
      case WALKING:
        return STAT_NAME_ANIMALS_POINTS;

      case WATER_SOURCE:
        return STAT_NAME_WATER_SOURCES_POINTS;

      case SPORE:
        return STAT_NAME_SPORES_POINTS;

      default:
        return STAT_NAME_BIOMES_POINTS;
        break;
    }
  }
