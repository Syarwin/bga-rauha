...
const OPTION_SYNTYMA_SHAMANS = 106;
const OPTION_SYNTYMA_SHAMANS_OFF = 0;
const OPTION_SYNTYMA_SHAMANS_ON = 1;

const OPTION_SYNTYMA_NEW_GODS = 107;
const OPTION_SYNTYMA_NEW_GODS_OFF = 0;
const OPTION_SYNTYMA_NEW_GODS_ON = 1;
const OPTION_SYNTYMA_NEW_GODS_ONLY = 2;
...
const STAT_SHAMAN_CRISTAL = 19;
const STAT_SHAMAN_POINTS = 20;
