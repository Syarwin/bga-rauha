...
$machinestates = [
  ...
  ST_CHOOSE_SHAMAN => [
    ...
    'descriptionmyturn' => clienttranslate('${you} must choose your shaman side'),
  ...
  ST_COUNT_ACTION => [
    ...
    'type' => 'activeplayer',
    'args' => 'argCountAction',
    'action' => 'stCountAction',
    'possibleactions' => ['actActivateBiome', 'actActivateGod', 'actActivateShaman'actSkip'],
    'transitions' => [
